...
export const products: Product[] = [
  {
    ...
    description: 'Premium heavyweight cotton tee featuring a clean, minimalist METAR weather report graphic. A Overcast original.',
    price: 35,
    category: 'Tees',
  ...
  },
  {
    id: '2',
    name: 'Horizon Tee',
    description: 'White tee with a sleek attitude indicator graphic representing the horizon line. Designed by the Overcast collective.',
    price: 35,
    category: 'Tees',
  ...
  },
  {
    id: '3',
    name: 'Flight Tag Tee',
    description: 'Minimalist tee inspired by the iconic "Remove Before Flight" tags found on aircraft. A staple piece of Overcast streetwear.',
    price: 35,
    category: 'Tees',
  ...
  },
  {
    ...
    description: 'Premium black hoodie with abstract atmospheric pressure line graphics. Engineered for comfort and style by Overcast.',
    price: 75,
    category: 'Hoodies',
  ...
  },
  {
    ...
    description: 'Technical hoodie featuring vector-based flight path geometry on the back. A signature Overcast design.',
    price: 75,
    category: 'Hoodies',
  ...
  },
  {
    ...
    description: 'Classic 6-panel dad hat with embroidered "7700" squawk code. The ultimate Overcast accessory.',
    price: 30,
    category: 'Hats',
